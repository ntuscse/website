...
import { clearRankingsMap, rankingCalculation, rankingsMap } from "../tasks/rankingCalculation";

describe('rankingCalculation', () => {
    const mockGetActiveSeasons = jest.spyOn(SeasonService, 'getActiveSeasons');
    const mockCalculateSeasonRankings = jest.spyOn(SeasonService, 'calculateSeasonRankings');
