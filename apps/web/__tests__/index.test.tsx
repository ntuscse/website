...
const posts = [
  {
    "node": {
      "id": "cG9zdDoxNjk1",
        ...
        "excerpt": "Techterview 101: Navigating the Internship World, a senior sharing event for the SCSE students took place on the 24th of",
        "author": {
        "node": {
          "id": "dXNlcjoz",
            "name": "acad"
  ...
  },
  {
    "node": {
      ...
      "excerpt": "Introducing the 21st Main Committee Mission of 21st Main Committee School of Computer Science and Engineering Club (CSEC",
      "author": {
        "node": {
          "id": "dXNlcjox",
          "name": "admin"
