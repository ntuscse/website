...
export const getQtyInCart = (cartItems: CartItem[], productId: string, colorway: string, size: string) : number => {
...
export const displayQtyInCart = (cartItems: CartItem[], productId: string, colorway: string, size: string) : string => {
